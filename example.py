...
if __name__ == '__main__':
    ...
    instruction = "修一条铁路，宽度为500米，需要计算占用周边的耕地面积。铁路数据是railway.shp，耕地数据是land.shp。"
    # instruction = "修一条铁路，宽度为500米，需要计算占用周边坡度小于10度的耕地面积。铁路是railway.shp，耕地是land.shp，地形数据是terrain.tif。"
